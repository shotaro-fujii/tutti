...
class News3ViewController: UIViewController,UIWebViewDelegate,XMLParserDelegate , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func parser(_ parser: XMLParser, foundCharacters string: String) {
        ...
        if element == "title"{
            ...
            } else if tagArray.last! == "\n\n\t\t"{
                print("\n\n\t\tです")
            } else if tagArray.last! == "\n\t\t"{
                print("\n\t\tです")
            
            } else{
                tag_outputArray.append(tagArray.last!)
                print("タグに追加されました")
            }
            //print(tag_outputArray)
        }
    }
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        ...
        if elementName == "item"{
            ...
            elements.setObject(tag_outputArray.last!, forKey: "tag" as NSCopying)
