...
class News6ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource,UIWebViewDelegate, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        //xmlを解析する（パース）
        let url:String = "http://localhost:8888/?feed=rss2"
